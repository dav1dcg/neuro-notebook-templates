...
- **[caiman_motion_correction](Notebooks/caiman_motion_correction.ipynb)**
    ...
    - Data_examples files: dendrite_ch1.tif, dendrite_ch2.tif
- **[cellpose_estimation_2p](Notebooks/cellpose_segmentation_2p.ipynb)**
    ...
    - Data_examples files: 2P_GCaMP8m.tif, 2P_somaFRCaMPi.tif
- **[dataframes_plots](Notebooks/dataframes_plots.ipynb)**
    ...
    - Data_examples files: cell_types_specimen_details.csv.
...
- **[lif_to_tif](Notebooks/lif_to_tif.ipynb)** 
    ...
    - Data_examples files: LIF01.lif, LIF02.lif, LIF03.lif.
- **[nd2_to_tif](Notebooks/nd2_to_tif.ipynb)**
    ...
    - Data_examples files: NIK01a01_seq.nd2, NIK01b01.nd2, NIK02a01.nd2.
- **[spectra_viewer](Notebooks/spectra_viewer.ipynb)**
    - A basic fluorescence spectra viewer.
    - Data_examples files: filter_spectrum_479-585.txt, filter_spectrum_524_628.txt, fp_spectra_egfp.csv, fp_spectra_mapple.csv, led_spectrum_M470L5.xlsx, led_spectrum_M565L3.xlsx.
- **[superplots](Notebooks/superplots.ipynb)**
    ...
    - Data_examples files: cell_types_specimen_details.csv, jcb_202001064_datas1.txt.
- **[time_series_preprocessing](Notebooks/time_series_preprocessing.ipynb)**
    ...
    - Data_examples files: WF01a.csv, WF02b.csv.
- **[video_to_tif](Notebooks/video_to_tif.ipynb)**
    ...
    - Data_examples files: FCM01.avi, FCM02a.mp4.

# Python4Neuro_2026

Notebooks adapted from the [ONWAR](https://onwar.nl/) course "Python for Neuroscience" 2026. Run them in Google Colab. 
...
1. [P4N_02_patch-clamp_APs ![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/dav1dcg/neuro-notebook-templates/blob/main/Python4Neuro_2026/P4N_02_patch-clamp_APs.ipynb)

1. [P4N_03_patch-clamp_dataframes ![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/dav1dcg/neuro-notebook-templates/blob/main/Python4Neuro_2026/P4N_03_patch-clamp_dataframes.ipynb)

1. [P4N_04_patch-clamp_events ![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/dav1dcg/neuro-notebook-templates/blob/main/Python4Neuro_2026/P4N_04_patch-clamp_events.ipynb)

1. [P4N_05_2P-ca_pre-processing ![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/dav1dcg/neuro-notebook-templates/blob/main/Python4Neuro_2026/P4N_05_2P-ca_pre-processing.ipynb)

1. [P4N_06_2P-ca_segmentation ![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/dav1dcg/neuro-notebook-templates/blob/main/Python4Neuro_2026/P4N_06_2P-ca_segmentation.ipynb)
